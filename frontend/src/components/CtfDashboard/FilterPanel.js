    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4">
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-gray-700">Quality Filters</span>
        </div>
        <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 px-2 py-1 text-sm border border-gray-200 rounded focus:outline-none focus:border-blue-300"
            />
