...
const initialState = {
  ...
  initialOffsetStep: 1,
  // Auto-sampling fields (frontend names)
  offSetRange: 5,
  offSetStep: 1,
  localAngularSearchRange: "1.8 degrees",
  relaxSymmetry: "",
  // Helix fields (backend names)
  tubeDiameter1: -1,
  tubeDiameter2: -1,
  angularRot: -1,
  angularTilt: 15,
  angularPsi: 10,
  rangeFactorOfLocal: -1,
  ...
  riseSearchMax: 0,
  riseSearchStep: 0,
  // Helix fields (frontend names used in Helix tab)
  innerDiameter: -1,
  outerDiameter: -1,
  localAveraging: -1,
  tiltPrior: "Yes",
  uniqueAsymmetricalUnits: 1,
  initialRise: 0,
  twistMin: 0,
  twistMax: 0,
  twistStep: 0,
  ...
  useSolventFlattenedFscs: "No",
  useBlushRegularisation: "No",
  initialAngularSampling: "7.5 degrees",
  LocalSearchfromAutoSampling: "1.8 degrees",
  RelaxSymmetry: "",
  finerAngularSampling: "No",
      ...
      <form onSubmit={handleSubmit} className="form-content ">
        {activeTab === "I/O" && (
          <Io
            ...
            jobType={JobTypes["3d_auto_refine"]}
